          ...
          <div class="container">
            <div class="row">
              <div class="col-md-6 col-sm-12">
                <div class="block">
                  <form action="ActualizarDatosUsuario2.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">                        
                    <label for="region">Selecciona Región:</label>
                      ...
                      <button class="btn btn-default" type="submit" name="ActualizarDatosUsuario2.php" >Actualizar</button>
