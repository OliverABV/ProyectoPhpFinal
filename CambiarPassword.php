          ...
          <div class="container">
            <div class="row">
              ...
              <div class="form-group" validate-input" data-validate="Dato Requerido">
                      <input type="password" id="pass" name="pass" class="form-control" placeholder="Ingresar Contraseña" data-type="password" required />                      
                    </div> 

                    <div class="form-group" validate-input" data-validate="Dato Requerido">
                      <input type="password" id="pass" name="pass" class="form-control" placeholder="Ingresar nueva Contraseña" data-type="password" required />                      
                    </div> 
                    <div class="form-group" validate-input" data-validate="Dato Requerido">
                      <input type="password" id="pass" name="pass" class="form-control" placeholder="Repetir nueva Contraseña" data-type="password" required />                      
                    </div>
